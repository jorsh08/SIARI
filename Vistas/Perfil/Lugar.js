...
const Lugar = (  {titulo, direccion, horario, puntuacion, imagen, navigation, route} ) => {
  const navigations = useNavigation();
    
  return (
    <TouchableOpacity style={[styles.mainView]} onPress={() => navigations.navigate("Informacion")}>
        <Image
